# Untested fork updated to latest engine version

The code was updated to the most recent engine version (release-20230330) at time of writing, but no effort was made to test it. Use at your own risk.

### Other changes
- renamed name of the `Fueltank` trait to `FuelTank`
- added `EnterCursor` and `EnterBlockedCursor` to `Refuelable` trait
